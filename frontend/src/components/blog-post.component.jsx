...
const BlogPostCard = ({ content, author }) => {
    ...
    return (
        <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-gry pb-5 mt-4">
            ...
            <div className="h-28 aspect-square bg-grey">
                <img src={banner} className="w-full h-full aspect-square object-cover" alt={title} />
            </div>
        </Link>
    )
}
