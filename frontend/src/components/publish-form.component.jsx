...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        if(!des.length || des.length > CharacterLimit){
            return toast.error(`Write a description for blog within ${CharacterLimit}`)
        }
        if(!tags.length){
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <p className="mt-1 text-dark-grey text-sm text-right">{ CharacterLimit - des.length } charcter left</p>

                    <p className="text-dark-grey mb-2 mt-9">Tags - (Helps in searching and likeing your publish blog)</p>
